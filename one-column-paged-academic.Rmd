...
<!-- ::: -->
::: {.mylink}
```{r, out.width = "80%", fig.height = 2.8, fig.width = 2.5}
library(tidyverse)
...
```{r, results = "asis"}
cat("<a href='https://haziqj.ml'><i class='fas fa-download'></i> PDF</a>")
```
:::

::: {.interests}
I am an **Assistant Professor in Statistics** at _Universiti Brunei Darussalam_ (UBD).
My interests lie in statistical methodology and computation, with applications towards the natural and social sciences.
