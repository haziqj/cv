...
## ---- Read data --------------------------------------------------------------
source("content/sync_w_gsheets.R")  # read data
...
The source code for this document is available from <span class='mylink'><a href='https://github.com/haziqj/cv'> github.com/haziqj/cv </a></span>. Document last rendered on `r Sys.time()` [`r Sys.timezone()`].
