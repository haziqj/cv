...
tab_sw <-
  ...
  blank_year_when_repeated() %>%
  select(year, number, citation)
knitr::kable(tab_sw |> slice(1:2))
```

<!-- <br class="pageBreak"> -->

```{r}
knitr::kable(slice(tab_sw, -(1:2)))
```
...
<!-- ```{r} -->
<!-- knitr::kable(talk_tab %>% slice(-(1:14))) -->
<!-- ``` -->
